...
| **通义千问** | tongyi.aliyun.com | 中文友好，免费 |
| **DeepSeek** | chat.deepseek.com | 中文友好，代码能力强 |

> 💡 对于 R 学习者，推荐优先使用 **ChatGPT** 或 **DeepSeek**，  
> 两者对 R 代码的理解都非常准确，且支持中文提问。
...
> "用 R 的 ggplot2 包，以 mtcars 数据集为例，  
> 画一个散点图，x 轴是车重（wt），y 轴是油耗（mpg），  
> 按气缸数（cyl）用不同颜色区分，加上线性趋势线，  
> 用 theme_classic() 主题，中文坐标轴标签。"
...
> 💡 **能看懂 > 能写出**。  
> 先让 AI 帮你生成代码，再逐行理解它在做什么，  
> 这是 R 小白进步最快的学习路径。

---

## 7 在 RStudio 中直接使用 AI
